...
/***/ function(module, exports, __webpack_require__) {
	...
	var BookList = (function (_super) {
	    ...
	    function BookList(props) {
	        ...
	        _this.showBookDetails = function (book) {
	            console.log(book);
	            ReactDOM.render(React.createElement(bookDetails_component_1.BookDetails, { book: book }), document.querySelector("#main"));
	        };
	        _this.state = { index: 0 };
	        return _this;
	    ...
	    BookList.prototype.render = function () {
	        ...
	        this.props.books.forEach(function (book) {
	            list.push(React.createElement("button", { type: "button", onClick: function () { return self.showBookDetails(book); }, className: "list-group-item" },
	                "Name: ",
	                book.name,
	                " ISBN: ",
	                book.isbn,
	...
	var NavBar = (function (_super) {
	    ...
	    function NavBar() {
	        ...
	        _this.showBookList = function () {
	            ReactDOM.render(React.createElement(bookList_component_1.BookList, { books: _this.context.books }), document.querySelector("#main"));
	        };
	        return _this;
	    }
